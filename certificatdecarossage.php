...
<nav class="navbar navbar-default" role="navigation">
    ...
    <a href="modifiercontrol.php" style="padding: 0 10px;" >modifier </a>
...
<div class="container-fluid" >
 ...
 html2pdf(document.getElementById('div_print'), pdf, function(pdf){
     pdf.save('file.pdf');
 });
 </script> -->
    <div id="div_print" >
    ...
    <div class="retitre" >
                <h2 class="heading-title text-center">Certificat de carossage</h2>
...
$inserttt=$bdd->prepare('INSERT INTO registrecontrol (affaire,marque,model,choix,format,ptac,nbrplace,modelenacelle,plancher,choixplancher,parois,choixparois,etagere,nivetagere,longetagere,nbbac,carburant,typecarburant,adblue,pese,roue1,roue2,roue3,roue4,options) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)');
$inserttt->execute(array($naffaire,$ma,$mo,$ch,$f,$pt,$nbpl,$monacelle,$plan,$chpl,$pa,$chpa,$etag,$nivetag,$longetag,$nbb,$carburant,$typecarburant,$adblue,$pese,$roue1,$roue2,$roue3,$roue4,$opt));
